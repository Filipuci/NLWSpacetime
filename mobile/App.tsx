...
export default function App() {
  ...
  return (
    <ImageBackground source={blurBg} className="flex-1 items-center relative bg-gray-900 px-8 py-10" imageStyle={{ position: 'absolute', left: '-100%'}}>
      ...
      <Text className='text-center leading-relaxed text-gray-200 text-sm font-body'>Feito com 💜 no NLW da Rocketseat</Text>
